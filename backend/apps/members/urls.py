...
from apps.members.registration_views import FamilyRegistrationView, MembershipTypeListView, RegistrationView, ValidateAddressView, ValidateDiscountCodeView
