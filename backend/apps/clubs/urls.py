...
from apps.clubs.views import ClubMeView, ClubOnboardView, MembershipTypeDetailView, MembershipTypeListCreateView
...
urlpatterns = [
    ...
    path('onboard/', ClubOnboardView.as_view(), name='club-onboard'),
]
